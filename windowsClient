...
class UI:
    ...
    def openSetup(self):
        ...
        self.usernameInput.text_size = self.fontSize - 2
        self.colorInput.text_size = self.fontSize - 2
        self.hostInput.text_size = self.fontSize - 2
        self.portInput.text_size = self.fontSize - 2
        self.keyInput.text_size = self.fontSize - 2
...
connectionInstance = Connection("tomm", "lightblue", "192.168.1.138", "61420", "184423647123")
uiInstance = UI()
